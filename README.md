...
This web app: uses [TheCatAPI](https://thecatapi.com/) to display information/images of different cat breeds. 
...
It was challenging to figure out how to pass props to different components and query using an API.
